          ...
          <div class="row">
            <div class="col">
              ...
              <table id="ttable" class="table mt-3 display">
                ...
                $sql ="SELECT * FROM `teacher` WHERE `registerStatus`=0";
                ...
                if(mysqli_num_rows($result)> 0)
                {
                  ...
                  <td class='manage-orders-td'>Name</td>
                  <td class='manage-orders-td'>update</td>
                  </tr> </thead><tbody> ";
                  while($row = mysqli_fetch_assoc($result))
                  {
                    echo   " <tr class='manage-orders-tr'>";
                    echo   " <td class='align-middle'><div class=''>".$row["teacherId"]."</div></td>  ";
                    echo   " <td class='align-middle'><div class=''>".$row["firstName"]."</div></td>  ";
                    echo   " <td class='align-middle'><div class=''>".$row["joinedDate"]."</div></td>  ";
                    echo "<td class='align-middle' width='48'><a href='register-teacher.php?id=".$row["teacherId"]."'><img src='../images/edit.png' alt='' width='20' height='22' /></a></td>  ";
                    echo "</tr>";
