            ...
            <table class="table" width="50%" border="0" align="center">
              <tr>
                ...
                <td class="updateitem-td" width=auto>
                  <input type="radio" class="p1" name="status" id="status" value='0' <?php if($row['regstatus']=0){echo "checked";}?>/>Reject &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                  <input type="radio" class="p1" name="status" id="status" value='1' <?php if($row['regstatus']=1){echo "checked";}?>/>Register
